define(['angular'],function(){
	...
	requirejs([
			...
			function($,Masonry){
				...
				var html = '';
				 var data = [1,2,3,1,2,3,1,2,3,1,2,3,1,2,3,1,2,3,1,2,3,1,2,3,1,2,3,1,2,31,2,3];
			    for ( var i = 0; i < 20; i++ ) {
			...
			function addItems(){
			      ...
			      for ( var i = 0; i < 20; i++ ) {
			        var elem = $('<div class="item"><div class="pic"><img src="img/muscle1.jpg" > </div> <div class="text">hello! how are you ?</div></div>')[0] //getItemElement();
